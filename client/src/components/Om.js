...
1. Innledning
Denne personvernerklæringen gjelder for Selskap AS (heretter omtalt som «vi») og forklarer hvorfor vi samler inn informasjon om deg, hvordan vi bruker denne informasjonen og hvordan vi tar hensyn til ditt personvern.
...
Når du registrerer deg og/eller handler på vår nettside, må du oppgi en del informasjon som lagres av oss, slik som navn, e-postadresse, adresse og mobilnummer. Vi vil også lagre opplysninger når du kontakter oss senere. Informasjonen du oppgir kan også berikes ved hjelp av oppslagstjenester eller sosiale medier du gir oss tilgang til.
